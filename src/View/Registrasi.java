...
public class Registrasi extends javax.swing.JFrame {
    ...
    private boolean showConfirmationPassword = false;
    public Registrasi() {
        initComponents();
        setLocationRelativeTo(null);
        addPlaceholderStyle(nameTextField);
        addPlaceholderStyle(usernameTextField);
        addPlaceholderStyle(emailTextField);
        addPlaceholderStyle(phoneNumberTextField);
        addPlaceholderStyle(passwordTextField);
        addPlaceholderStyle(confirmationPasswordTextField);
        setOnlyInteger(phoneNumberTextField);
        setOnlyAlphaNumeric(nameTextField);
    }
    
    private void setOnlyAlphaNumeric(java.awt.TextField textField) {
    ...
    private void setOnlyInteger(java.awt.TextField textField) {
    textField.addKeyListener(new KeyListener() {
        @Override
        public void keyTyped(KeyEvent e) {
            char c = e.getKeyChar();
    ...
    public void addPlaceholderStyle(java.awt.TextField textField){
    ...
    public void removePlaceholderStyle(java.awt.TextField textField){
        Font font = textField.getFont();
        ...
        if (petugasC.validasiRegistrasi(username, namaPetugas, emailPetugas, nomorHandphone, kataSandi, konfirmasiKataSandi)){
            if (petugasC.isUsernameUnique(username)){
                if (petugasC.validateEmail(emailPetugas)){
                    ...
                    JOptionPane.showMessageDialog(this, "Mohon masukkan email anda dengan benar!");
                }
            } else {
    ...
    private void usernameTextFieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_usernameTextFieldFocusGained
        if(usernameTextField.getText().equals("Username")){
            ...
            removePlaceholderStyle(usernameTextField);
        }
    ...
    private void phoneNumberTextFieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_phoneNumberTextFieldFocusGained
        if(phoneNumberTextField.getText().equals("Nomor Handphone")){
            ...
            removePlaceholderStyle(phoneNumberTextField);
        }
    ...
    private void passwordTextFieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_passwordTextFieldFocusGained
       if(passwordTextField.getText().equals("Kata Sandi")){
            ...
            removePlaceholderStyle(passwordTextField);
        }
    ...
    private void confirmationPasswordTextFieldFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_confirmationPasswordTextFieldFocusGained
        if(confirmationPasswordTextField.getText().equals("Konfirmasi Kata Sandi")){
            ...
            removePlaceholderStyle(confirmationPasswordTextField);
        }
