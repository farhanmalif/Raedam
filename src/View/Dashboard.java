...
public class Dashboard extends javax.swing.JFrame {
    ...
    /**
     * Creates new form dah
     */
    
    private final ParkirController parkirC = new ParkirController();

    private String tipeParkirEdit;
    private String jenisKendaraanEdit;
    public Dashboard() {
        initComponents();
    ...
    private void initComponents() {
        ...
        for (int i = parkirC.getListParkir().size()-1; i >= 0; i--){
            for (int j = 5; j >= 0; j--){
                if (j == 0) {
                    objek[i][j] = parkirC.getListParkir().get(i).getTipeParkir();
                } else if (j == 1) {
                    objek[i][j] = parkirC.getListParkir().get(i).getPlatNomor();
                } else if (j == 2) {
                    objek[i][j] = parkirC.getListParkir().get(i).getJenisKendaraan();
                } else if (j == 3) {
                    ...
                    objek[i][j] = parkirC.getListParkir().get(i).getStatusParkir();
                }
            }
        }
