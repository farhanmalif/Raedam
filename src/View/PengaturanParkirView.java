...
public class PengaturanParkirView extends javax.swing.JFrame {
    ...
    public PengaturanParkirView() {
        ...
        setOnlyInteger(kuotaMobilTextField);
        setOnlyInteger(kuotaMotorTextField);
        setOnlyInteger(motorPerJamTextField);
        setOnlyInteger(motorPerHariTextField);
        setOnlyInteger(mobilPerJamTextField);
        setOnlyInteger(mobilPerHariTextField);
    }
